          ...
          <div className="content-block">
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                <input type="text" id="surname" name="surname" className="form-control"  placeholder="Surname(s)"  defaultValue={props.client.surname} />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                <input type="text" id="forename" name="forename" className="form-control"  placeholder="Forename(s)" defaultValue={props.client.forename} />
              </div>
            </div>
